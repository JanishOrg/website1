    ...
    <div class="row">
        ...
        <div class="col-md-3 mb-2 mb-md-0">
            <ul class="nav nav-pills flex-column nav-left">
                ...
                <li class="nav-item">
                    <a class="nav-link" id="account-pill-refund" data-toggle="pill" href="#account-vertical-qr"
                        aria-expanded="false">
                        <i class="las la-undo-alt font-medium-3 mr-1"></i>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="tab-content">
                        ...
                        <!--/ Privacy Policy -->
                                        <!-- QR Code tab -->
                <div class="tab-pane fade" id="account-vertical-qr" role="tabpanel" aria-labelledby="account-pill-qr" aria-expanded="false">
                    <!-- form -->
                    <form class="qr_setting" method="post" action="{{ route('update.qr') }}" enctype="multipart/form-data" data-parsley-validate autocomplete="off">
                        @csrf
                        <div class="row">
                            <!-- QR Code header -->
                            <div class="col-12">
                                <div class="d-flex align-items-center mb-2">
                                    <i class="las la-qrcode font-medium-3 mr-1"></i>
                                    <h4 class="font-weight-bold mb-0 ml-75">QR Code Settings</h4>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    <label>QR Code Image <span class="text-danger">*</span></label>
                                    <input type="file" accept="image/*" class="dropify qr_code" name="qr_code" data-height="126" required />
                                </div>
                            </div>
                            <div class="col-12">
                                <button type="submit" class="btn btn-primary mt-2 mr-1 float-right">Upload QR Code</button>
                            </div>
                        </div>
                    </form>
                    <!--/ form -->
