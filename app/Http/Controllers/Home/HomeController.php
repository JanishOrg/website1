...
class HomeController extends Controller
{
    ...
    public function fetchLeaderboardData(Request $request)
    {
        $leaderboardData = Userdata::select('playerid', 'username', 'photo', DB::raw('fourPlayWin + fruitscore as totalScore'))
